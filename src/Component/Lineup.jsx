  ...
  return (
    <div className="pt-[50px]">
      <div className="flex items-center justify-between pb-[100px]">
        <div className="h-[25px] lg:w-[520px] max-md:w-[120px] bg-[#35140F] border-r-[7px] border-t-[7px] border-b-[7px] border-white"></div>
        <h1 className="text-[#35140F] font-Normal lg:text-[40px] max-md:text-[20px] lg:font-outline-2-white max-md:font-outline-1-white">
          Line Up
        </h1>
        <div className="h-[25px] lg:w-[520px] max-md:w-[120px] bg-[#35140F] border-l-[7px] border-t-[7px] border-b-[7px] border-white"></div>
      </div>
