  ...
  return (
    <div>
      <div className='flex items-center justify-between pb-[100px]'>
        <div className='h-[25px] lg:w-[520px] min-[300px]:w-[90px] bg-[#35140F] border-r-[7px] border-t-[7px] border-b-[7px] border-white'></div>
        <h1 className='text-[#35140F] font-Normal lg:text-[40px] min-[300px]:text-[20px] lg:font-outline-2-white min-[300px]:font-outline-1-white'>throwback</h1>
        <div className='h-[25px] lg:w-[520px] min-[300px]:w-[90px] bg-[#35140F] border-l-[7px] border-t-[7px] border-b-[7px] border-white'></div>
      </div>
