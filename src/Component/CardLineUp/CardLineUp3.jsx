...
export default function CardLineUp3() {
  return (
    <div className='flex flex-col relative items-center group lg:mr-[54px] min-[300px]:mr-[20px]'>
      ...
      <img src={jansen_doang} className="absolute z-20 grayscale group-hover:grayscale-0" alt='' />
      <img src={tulisan_jansen} alt='' className='hidden text-white z-40 font-Normal group-hover:block sticky -mt-[430px] font-bold'/>
