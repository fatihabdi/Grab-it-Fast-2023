...
export default function Mascot() {
  return (
    <div className="overflow-auto lineup">
      <Navbar />
      <div className="flex relative flex-col md:h-screen items-center min-[300px]:pt-[130px] md:pt-[150px] justify-center">
        ...
        <img src={judulmascot} className="absolute hidden top-[120px] md:block" alt="" />
